    ...
    try {
        ...
        GenericAgent agent{
            ...
            HumanoidModelV0Data{
                ...
                parameters.support_foot,
                intoPoint(parameters.step_target),
                intoPoint3D(parameters.head_position),
                intoPoint3D(parameters.pelvis_left_position),
                intoPoint3D(parameters.pelvis_right_position),
                intoPoint3D(parameters.shoulder_right_position),
                intoPoint3D(parameters.shoulder_left_position),
