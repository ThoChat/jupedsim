...
private:
     ...
     * @param ped1 reference to Pedestrian 1 on whom the force acts on
     * @param ped2 reference to Pedestrian 2, from whom the force originates
     * @param shoulder_width_scaling_factor scaling factor for shoulder width
     * @return magnitude of the torque around the shoulder joint
     */
    double AgentTorque(const GenericAgent& ped1, const GenericAgent& ped2, double SHOULDER_WIDTH_SCALING_FACTOR) const;
