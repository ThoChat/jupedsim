        ...
        .def_property_readonly(
            ...
            [](const JPS_Agent_Wrapper& w)
                -> std::variant<
                    ...
                    std::unique_ptr<JPS_HumanoidModelV0State_Wrapper>> {
                switch(JPS_Agent_GetModelType(w.handle)) {
                    ...
                    case JPS_HumanoidModelV0:
                        return std::make_unique<JPS_HumanoidModelV0State_Wrapper>(
                            JPS_Agent_GetHumanoidModelV0State(w.handle, nullptr));
                }
